...
namespace geometry_gen
{
        ...
        MyGeometry generate_rectangle_two_sides(float width, float height)
        {
                ...
                vert[3].plane_coord[0] = 0.0f;
                vert[3].plane_coord[1] = 1.0f;
                vert[4].plane_coord[0] = 0.0f;
                vert[4].plane_coord[1] = 0.0f;
                vert[5].plane_coord[0] = 1.0f;
                vert[5].plane_coord[1] = 0.0f;
                vert[6].plane_coord[0] = 1.0f;
                vert[6].plane_coord[1] = 1.0f;
                vert[7].plane_coord[0] = 0.0f;
                vert[7].plane_coord[1] = 1.0f;
                ...
                for (size_t k = 0; k < 4; ++k) {
                        ...
                        /* cyan color for front side by default */
                        vert[k].def_color[0] = 0.0f;
                        vert[k].def_color[1] = 1.0f;
                        vert[k].def_color[2] = 1.0f;
                        vert[k].def_color[3] = 1.0f;
                        /* magenda color for back side by default */
                        vert[k + 4].def_color[0] = 1.0f;
                        vert[k + 4].def_color[1] = 0.0f;
                        vert[k + 4].def_color[2] = 1.0f;
                        vert[k + 4].def_color[3] = 1.0f;
                        
                        /* normal is along z-direction by default for first side */
                        vert[k].normal[0] = 0.0f;
                        vert[k].normal[1] = 0.0f;
                        vert[k].normal[2] = -1.0f;
                        /* normal is against z-direction by default for second side */
        ...
        MyGeometry generate_cube(float sz)
        {
                ...
                /* 1st side */
                vert[0].plane_coord[0] = 0.0f; vert[0].plane_coord[1] = 0.0f;
                ...
                vert[1].plane_coord[0] = 1.0f; vert[1].plane_coord[1] = 0.0f;
                ...
                vert[2].plane_coord[0] = 1.0f; vert[2].plane_coord[1] = 1.0f;
                ...
                vert[3].plane_coord[0] = 0.0f; vert[3].plane_coord[1] = 1.0f;
                ...
                /* 2nd side */
                vert[4].plane_coord[0] = 0.0f; vert[4].plane_coord[1] = 0.0f;
                vert[4].def_color[0] = 0.0f; vert[4].def_color[1] = 1.0f; vert[4].def_color[2] = 0.0f; vert[4].def_color[3] = 1.0f;
                vert[4].normal[0] = 1.0f; vert[4].normal[1] = 0.0f; vert[4].normal[2] = 0.0f;
                vert[5].plane_coord[0] = 1.0f; vert[5].plane_coord[1] = 0.0f;
                vert[5].def_color[0] = 0.0f; vert[5].def_color[1] = 1.0f; vert[5].def_color[2] = 0.0f; vert[5].def_color[3] = 1.0f;
                vert[5].normal[0] = 1.0f; vert[5].normal[1] = 0.0f; vert[5].normal[2] = 0.0f;
                vert[6].plane_coord[0] = 1.0f; vert[6].plane_coord[1] = 1.0f;
                vert[6].def_color[0] = 0.0f; vert[6].def_color[1] = 1.0f; vert[6].def_color[2] = 0.0f; vert[6].def_color[3] = 1.0f;
                vert[6].normal[0] = 1.0f; vert[6].normal[1] = 0.0f; vert[6].normal[2] = 0.0f;
                vert[7].plane_coord[0] = 0.0f; vert[7].plane_coord[1] = 1.0f;
                vert[7].def_color[0] = 0.0f; vert[7].def_color[1] = 1.0f; vert[7].def_color[2] = 0.0f; vert[7].def_color[3] = 1.0f;
                vert[7].normal[0] = 1.0f; vert[7].normal[1] = 0.0f; vert[7].normal[2] = 0.0f;

                /* 3rd side */
                vert[8].plane_coord[0] = 0.0f; vert[8].plane_coord[1] = 0.0f;
                vert[8].def_color[0] = 1.0f; vert[8].def_color[1] = 0.0f; vert[8].def_color[2] = 0.0f; vert[8].def_color[3] = 1.0f;
                vert[8].normal[0] = 0.0f; vert[8].normal[1] = 0.0f; vert[8].normal[2] = 1.0f;
                vert[9].plane_coord[0] = 1.0f; vert[9].plane_coord[1] = 0.0f;
                vert[9].def_color[0] = 1.0f; vert[9].def_color[1] = 0.0f; vert[9].def_color[2] = 0.0f; vert[9].def_color[3] = 1.0f;
                vert[9].normal[0] = 0.0f; vert[9].normal[1] = 0.0f; vert[9].normal[2] = 1.0f;
                vert[10].plane_coord[0] = 1.0f; vert[10].plane_coord[1] = 1.0f;
                vert[10].def_color[0] = 1.0f; vert[10].def_color[1] = 0.0f; vert[10].def_color[2] = 0.0f; vert[10].def_color[3] = 1.0f;
                vert[10].normal[0] = 0.0f; vert[10].normal[1] = 0.0f; vert[10].normal[2] = 1.0f;
                vert[11].plane_coord[0] = 0.0f; vert[11].plane_coord[1] = 1.0f;
                vert[11].def_color[0] = 1.0f; vert[11].def_color[1] = 0.0f; vert[11].def_color[2] = 0.0f; vert[11].def_color[3] = 1.0f;
                vert[11].normal[0] = 0.0f; vert[11].normal[1] = 0.0f; vert[11].normal[2] = 1.0f;

                /* 4th side */
                vert[12].plane_coord[0] = 0.0f; vert[12].plane_coord[1] = 0.0f;
                vert[12].def_color[0] = 0.0f; vert[12].def_color[1] = 1.0f; vert[12].def_color[2] = 0.0f; vert[12].def_color[3] = 1.0f;
                vert[12].normal[0] = -1.0f; vert[12].normal[1] = 0.0f; vert[12].normal[2] = 0.0f;
                vert[13].plane_coord[0] = 1.0f; vert[13].plane_coord[1] = 0.0f;
                vert[13].def_color[0] = 0.0f; vert[13].def_color[1] = 1.0f; vert[13].def_color[2] = 0.0f; vert[13].def_color[3] = 1.0f;
                vert[13].normal[0] = -1.0f; vert[13].normal[1] = 0.0f; vert[13].normal[2] = 0.0f;
                vert[14].plane_coord[0] = 1.0f; vert[14].plane_coord[1] = 1.0f;
                vert[14].def_color[0] = 0.0f; vert[14].def_color[1] = 1.0f; vert[14].def_color[2] = 0.0f; vert[14].def_color[3] = 1.0f;
                vert[14].normal[0] = -1.0f; vert[14].normal[1] = 0.0f; vert[14].normal[2] = 0.0f;
                vert[15].plane_coord[0] = 0.0f; vert[15].plane_coord[1] = 1.0f;
                vert[15].def_color[0] = 0.0f; vert[15].def_color[1] = 1.0f; vert[15].def_color[2] = 0.0f; vert[15].def_color[3] = 1.0f;
                ...
                /* 6th side */
                vert[20].plane_coord[0] = 0.0f; vert[20].plane_coord[1] = 0.0f;
                vert[20].def_color[0] = 0.0f; vert[20].def_color[1] = 0.0f; vert[20].def_color[2] = 1.0f; vert[20].def_color[3] = 1.0f;
                vert[20].normal[0] = 0.0f; vert[20].normal[1] = -1.0f; vert[20].normal[2] = 0.0f;
                vert[21].plane_coord[0] = 1.0f; vert[21].plane_coord[1] = 0.0f;
                vert[21].def_color[0] = 0.0f; vert[21].def_color[1] = 0.0f; vert[21].def_color[2] = 1.0f; vert[21].def_color[3] = 1.0f;
                vert[21].normal[0] = 0.0f; vert[21].normal[1] = -1.0f; vert[21].normal[2] = 0.0f;
                vert[22].plane_coord[0] = 1.0f; vert[22].plane_coord[1] = 1.0f;
                vert[22].def_color[0] = 0.0f; vert[22].def_color[1] = 0.0f; vert[22].def_color[2] = 1.0f; vert[22].def_color[3] = 1.0f;
                vert[22].normal[0] = 0.0f; vert[22].normal[1] = -1.0f; vert[22].normal[2] = 0.0f;
                vert[23].plane_coord[0] = 0.0f; vert[23].plane_coord[1] = 1.0f;
                vert[23].def_color[0] = 0.0f; vert[23].def_color[1] = 0.0f; vert[23].def_color[2] = 1.0f; vert[23].def_color[3] = 1.0f;

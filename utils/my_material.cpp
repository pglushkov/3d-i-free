...
MyMaterial::MyMaterial()
{
        ...
        std::string vshader(my_utils::ReadTextFromFile(MyWorld::Default_VShader()));
        std::string fshader(my_utils::ReadTextFromFile(MyWorld::Default_FShader()));
...
void MyMaterial::UseMaterial(bool use) const
{
        char tex_name[20];
        if (use) {
